...
class Serie
{
    ...
    #[Assert\NotBlank(message: "Veuillez fournir un titre pour la série !")]
    ...
    #[Assert\Choice(choices: ["Annuler", "Retour", "Terminer"])]
    private ?string $status = null;

    #[ORM\Column(type: Types::DECIMAL, precision: 3, scale: 1)]
    #[Assert\Range(min: 0, max: 10, notInRangeMessage: "La note ne peut aller que de 0 à 10 !")]
